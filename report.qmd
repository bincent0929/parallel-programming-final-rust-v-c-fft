...
Vendor ID:                   AuthenticAMD
  Model name:                QEMU Virtual CPU version 2.5+
    ...
    Stepping:                1
    BogoMIPS:                7797.06
    Flags:                   fpu de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat pse36 clflush mmx fxsr sse sse2 ht syscall nx lm rep_good nopl cpuid extd_apicid 
                             tsc_known_freq pni ssse3 cx16 sse4_1 sse4_2 x2apic popcnt aes hypervisor lahf_lm cmp_legacy 3dnowprefetch vmmcall
...
This is due to the fact that the FFT equation's max possible peak is relative to how many samples are available to be processed. So no peak will be any greater than $1 / THREAD_COUNT$ for parallelized FFTs in Rust.
...
Nevertheless across all thread counts, C was faster than Rust by at least $1.38$ times.
...
I can also conclude that Rust benefits more from higher thread counts than C. Though more of the Rust code was parallelizable than the C code.
