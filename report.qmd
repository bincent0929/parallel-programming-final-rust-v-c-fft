...
I can also conclude that Rust benefits more from higher thread counts than C in this case. Though more of the Rust code was parallelizable than the C code in theory.
